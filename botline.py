...
#tinkerbell
cl = LINETCR.LINE()
cl.login(token="oZPIZSgmjvp9qigKB9TgO/mpD+UR3wVNCWamosDXEhQ0iehxD5bqKyJTD5Hcl0mHRcG/x9S3JcF0SPAg7F6MfHkUfSf3EneBqet+IkXELPedK6I2t8HXOklyifFKGsTtOVAZanih60MBZ7rhI2bwJAdB04t89/1O/w1cDnyilFU=")
cl.loginResult()
#vidia
kt = LINETCR.LINE()
kt.login(token="EnKK9r18cOzGIZTIMfW0.nu6d9NykjaDn0quKJvd6ua.cBmKQs3rp1gj/DHauE4C9OBCorbKSoKxW3nZy+5v9+Y=")
kt.loginResult()
#rosetta
ks = LINETCR.LINE()
ks.login(token="EnSyKKmZLxRHoCX18Pra.mCayG/kbR0qYFBOfGp8NMG.1hZMv2vkPwxDFwC0ab6Dx+iq1YIoAIINm55Q++8vryk=")
ks.loginResult()
#sirvelmist
ki = LINETCR.LINE()
ki.login(token="En0WulH8nVsuIge9hic4.ue7PV7eoa2RF9Ip392eEHa.zIAHhTLjlFQBcIs5v/csvTbwDRNQzoe7XzE7P5QQeVo=")
ki.loginResult()
#fawn
kk = LINETCR.LINE()
kk.login(token="EniDOqKoMh7tuJCPTdy1.RcBrahgDVdSXY6s5Fvb74q.8oHAVPh6DPSrPQDaOM7gdkz5LMmNsGoYHc4HFm109EY=")
kk.loginResult()
#iridessa
kc = LINETCR.LINE()
kc.login(token="EnUMLPW1yUH05Grg0Gr7.B2d/8V4YsZrB167uAlSOTW.crdYnEXh9RAxlkUMec5Xw1lmX9bVPcL3p5n6vVThY80=")
kc.loginResult()

#kicker ghost
kl = LINETCR.LINE()
kl.login(token="Eni8R6Z6Xv42Y6V2i9Vd.R76+6Xz9D5Uy0tdFgrHJBq.rD2pVeg8i+Il7Qbswee1Jk7iSKU4L68HxnX8UdsvXTQ=")
kl.loginResult()
